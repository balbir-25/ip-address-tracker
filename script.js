...
let mymap = L.map('map').setView([30.341391, 76.401840], 13);
let marker = L.marker([30.341391, 76.401840], { icon: myIcon }).addTo(mymap);

marker.bindPopup(`IP Address: <b>180.188.249.159</b><br>Location: <b>Patiala, Punjab, India </b>`);
